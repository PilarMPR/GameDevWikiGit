...
## 11. Hot Potato — Design Implications

| Decision | Rationale |
|---|---|
| Clear, readable game state at all times | Cognitive load; working memory limit — don't make players *deduce* who is the Potato |
| "Punchline" loss state (crying animation) | Loss aversion + social = memorable; makes defeat funny rather than just punishing |
| FAP accrues visibly | Visible progress (Lens #49) + competence feedback; players need to see their skill manifested |
| Short match (3–5 min) | Retention loop + attention span; social games need to deliver a complete arc per session |
| 2-item slots | Respects working memory; too many simultaneous items = cognitive overload under social pressure |
| Tutorial through play, not popups | Procedural LTM encoding requires doing; popups during play fail (inattentional blindness) |
| Exaggerated feedback on all interactions | Pattern-mastery feedback loop — every successful dodge/troll should feel rewarding, building competence |

...
## 10. Hot Potato — UI/Interface Implications

| Decision | Rationale |
|---|---|
| Non-diegetic HUD (score, timer, role indicator) | Party game; readability and information density over immersion |
| FAP scores visible at all times | Level 1 critical information; king-of-hill targeting requires knowing who's winning |
| Potato role: large, obvious visual indicator on player + minimap | Avoid "who is the Potato right now?" confusion at all times |
| Timer: prominent, visible, and audio-escalating in final 30s | Urgency communication; Level 1 critical information |
| No HUD elements that require reading during combat | High-attention state; all combat info must be spatial/color, not text |
| Colorblind-friendly player colors | ~8% of audience; shapes + patterns as secondary identifiers alongside colors |
| TV-readable font sizes (min 28pt) | Couch gaming at distance |
| Pause menu: 2 levels deep maximum | Party game; players should be able to resume instantly |

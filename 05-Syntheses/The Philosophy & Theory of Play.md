...
**Design implication for Hot Potato:** players voluntarily agree that "if you're holding the potato when the timer ends, you lose." This is a constitutive rule that makes no real-world sense — but players accept it because the *play* of the game (the chasing, the trolling, the laughter) is the point. Any mechanic that makes players feel *obligated* to continue when they'd prefer to stop begins to erode the lusory attitude.
...
## 10. Hot Potato — Philosophical Implications

| Principle | Hot Potato application |
|---|---|
| Voluntary (Huizinga) | Match joining and leaving must feel voluntary; no punitive lock-in; the game should make players *want* to play again |
| Uncertain (Huizinga) | Chaos injection (items, environment) ensures no match is predetermined |
| Autotelic (Huizinga) | FAP trolling must be intrinsically fun; if players only care about winning, not playing, the design has failed |
| Lusory attitude | Players must believe the constitutive rules (timer = loss) are worth accepting; the fun of the game must justify the rules |
| Meaningful play (Salen & Zimmerman) | Tag events must be discernible (clear who got tagged) and integrated (tagging matters to the match outcome) |
| Porous magic circle | Social commentary/laughter at the potato's expense is a feature; it extends play into real social life — which is good for a party game |
| Procedural rhetoric | Hot Potato makes an argument through its rules: social connection and chaos are fun; passive play is penalized; everyone is at risk |

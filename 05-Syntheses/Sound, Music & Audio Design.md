...
## 7. Music Direction for Hot Potato

(A design note, not a canon citation)

Given what the canon says about music's role and party game tone:

- **Style:** energetic, cartoon-adjacent, high-tempo during matches. Should feel like a playground or gym game in sonic form.
- **Adaptive layers:** calm ambient during pre-match → driving rhythm during match → rising intensity as timer runs low → dramatic stinger when Potato explodes → comedic resolution cue for loser
- **Character themes:** optional per-character musical motif reinforces identity
- **Countdown audio:** clear audio escalation as the match timer approaches zero — this is a crucial tension-building moment
- **Victory/defeat stingers:** distinctive, short, instantly recognizable. The Potato-loser's defeat jingle should be comedic, not harsh.
...
## 9. Hot Potato — Audio Design Implications

| Decision | Rationale |
|---|---|
| Exaggerated cartoon sounds for all interactions | Party game tone; non-diegetic is fine; consistent with high-energy aesthetic |
| Hard sync sound on tag event | Tag is the core mechanic event; audio must arrive on the exact impact frame (s007) |
| Pitch-varied footsteps and movement sounds | Organic feel; prevents robotic repetition (s007) |
| Ambient music ramps as timer decreases | Adaptive music driving tension (s005, ch.16); the urgency must be felt before it's read |
| Clear audio tell before Potato explosion | Warning feedback; player had the information; fairness of outcome |
| Visual companion to all audio warnings | Accessibility; TV speakers may be poor; not everyone has full hearing |
| Comedic defeat stinger for Potato loser | Punchline mechanic reinforced by audio — loss is funny, not harsh |

...
**Directly relevant to:** Wild Alchemists' B2B educational games studio
...
- **Quest to Learn (NYC)**: a full school built on game-based learning principles; founded by Katie Salen. Not a product but a proof of concept for the philosophy. → [[../entities/katie-salen-eric-zimmerman]]
...
- [[../concepts/theory/theory-of-fun]] — Koster's theoretical foundation: fun = learning
- [[../concepts/player/motivation]] — SDT; intrinsic motivation; the undermining effect
- [[../concepts/player/flow-channel]] — the flow channel = the Zone of Proximal Development
- [[../concepts/theory/mda-framework]] — designing toward learning outcomes via MDA
- [[../concepts/production/playtesting]] — playtesting with classroom populations
- [[../analyses/among-us]] — social deduction as educational content
- [[../entities/katie-salen-eric-zimmerman]] — Quest to Learn precedent
- [[../entities/raph-koster]] — the theoretical bridge

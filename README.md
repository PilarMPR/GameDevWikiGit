...
A compounding, LLM-assisted **game design research wiki** — atomic notes distilled from 17 canonical game design books, cross-source syntheses, reference sheets, and a live project design space (the party brawler *Hot Potato*).
...
| [`40-HotPotato`](40-HotPotato) | Design space for the *Hot Potato* project (GDD) |

...
- [feedback-systems](feedback-system-design.md) — polish layer and feedback are the third building block
- [game-feel-3cs](game-feel-definition.md) — the product-level 3Cs model
- [player-psychology-perception](player-psychology-perception.md) — proprioception and kinesthetic self-extension

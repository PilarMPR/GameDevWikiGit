...
This is the highest example of [story-and-games](../../10-Library/notes/story-narrative-approaches.md)' meaningful play principle: the game's core mechanic (die and return) is integrated into the narrative rather than contradicting it.
...
→ [progression-systems](../../10-Library/notes/progression-systems-definition.md) (unlock systems vs. power systems)
...
→ [core-mechanics](../../10-Library/notes/mechanics-definition.md) (asymmetric design) · [game-balance](../../10-Library/notes/game-balance-overview.md) (intransitive relationships)
...
→ [motivation](../../10-Library/notes/player-motivation-maslow.md) (intrinsic vs. extrinsic; SDT Relatedness) · [game-loops](../../10-Library/notes/game-loops-definition.md) (relationship loops as outer loop)

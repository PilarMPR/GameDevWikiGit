...
> ⭐ This is the highest example of [level-design](../../10-Library/notes/level-design-principles.md)'s "show before ask" principle. Portal 2 is the reference case.

→ [level-design](../../10-Library/notes/level-design-principles.md) (teaching through levels) · [puzzles](../../10-Library/notes/puzzle-design-principles.md) (puzzle principles #1-3: clear goal, easy start, sense of progress)
...
→ [indirect-control](../../10-Library/notes/indirect-control-methods.md) · [world-building](../../10-Library/notes/world-building-principles.md) (environmental storytelling)
...
→ [multiplayer-systems](../../10-Library/notes/multiplayer-conflict-types.md) · [player-types](../../10-Library/notes/bartle-four-types.md) (Fellowship aesthetic through forced coordination)
...
→ [puzzles](../../10-Library/notes/puzzle-design-principles.md) (satisfying solutions + principle #9) · [theory-of-fun](../../10-Library/notes/fun-as-learning-koster.md) (grokking)
